...
beforeEach(async () => {
  ...
  comment = await Comment.create({ guest: user, rent: rent, title: "Feels good man", content: "Trump is number 1! Long live America! Hail victory! Hail teh peoplez!", approves: true })
})
